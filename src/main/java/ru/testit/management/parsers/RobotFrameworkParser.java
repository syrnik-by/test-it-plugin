...
public class RobotFrameworkParser {
    ...
    private static final String ALLURE_FEATURE_LABEL_NAME = "feature";
    ...
    private static final String ALLURE_ID_LABEL_NAME = "as_id";
    ...
    private static final String ALLURE_FEATURE = ALLURE_LABEL + ALLURE_FEATURE_LABEL_NAME + KEY_VALUE_SEPARATOR;
    ...
    private static final String ALLURE_ID = ALLURE_METHOD + ALLURE_ID_LABEL_NAME + KEY_VALUE_SEPARATOR + KEY_VALUE_SEPARATOR;
    ...
    private static final String LABEL_ID_VALUE_ANNOTATION = ALLURE_METHOD + "(?<" + LABEL_VALUE_ANNOTATION_NAME + ">\\S+)";
    ...
    private static final String TMS_LABELS = TMS_METHOD_OBJECT + "labels" + KEY_VALUE_SEPARATOR;
    private static final String TMS_LINKS = TMS_METHOD_OBJECT + "links" + KEY_VALUE_SEPARATOR;
    private static final String TMS_NAMESPACE = TMS_METHOD_OBJECT + "nameSpace" + KEY_VALUE_SEPARATOR;
    private static final String TMS_CLASSNAME = TMS_METHOD_OBJECT + "className" + KEY_VALUE_SEPARATOR;
    private static final String TMS_DISPLAY_NAME = TMS_METHOD_OBJECT + "displayName" + KEY_VALUE_SEPARATOR;
    ...
    static {
        ...
        patternActions.put(Pattern.compile(ALLURE_OTHER_FUNCTIONS_LABELS, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseOtherFunctionsLabels);
        patternActions.put(Pattern.compile(ALLURE_STEP, Pattern.MULTILINE), TMS_STEP);
        patternActions.put(Pattern.compile(ALLURE_LINK, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseLinkAnnotation);
        patternActions.put(Pattern.compile(ALLURE_ISSUE, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseLinkAnnotation);
        patternActions.put(Pattern.compile(ALLURE_TESTCASE, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseLinkAnnotation);
        ...
        patternActions.put(Pattern.compile(ALLURE_ID, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseIdLabel);
        ...
        patternActions.put(Pattern.compile(ALLURE_DYNAMIC_LINK, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseLinkMethod);
        patternActions.put(Pattern.compile(ALLURE_DYNAMIC_ISSUE, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseLinkMethod);
        patternActions.put(Pattern.compile(ALLURE_DYNAMIC_TESTCASES, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseLinkMethod);
        ...
        patternActions.put(Pattern.compile(ALLURE_DYNAMIC_ATTACHMENT_WRITE, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseWriteAttachMethod);
        patternActions.put(Pattern.compile(ALLURE_DYNAMIC_ATTACHMENT_READ, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseReadAttachMethod);
        patternActions.put(Pattern.compile(ALLURE_DYNAMIC_PARAMETER, Pattern.MULTILINE), (Function<MatchInfo, String>) RobotFrameworkParser::parseParameterMethod);
    }
    ...
    private static String parseOtherFunctionsLabels(MatchInfo matchInfo) {
        ...
        String name = m.group(LABEL_VALUE_ANNOTATION_NAME);
        return TMS_LABELS + "${{['" + name + "']}}";
    }

    private static String parseIdLabel(MatchInfo matchInfo) {
        Matcher m = Pattern.compile(LABEL_ID_VALUE_ANNOTATION).matcher(matchInfo.getText());
        if (!m.find()) throw new RuntimeException("Can't get value from annotation " + matchInfo.getText());
        String name = m.group(LABEL_VALUE_ANNOTATION_NAME);
        return TMS_LABELS + "${{['" + name + "']}}";
    }
    ...
    private static String parseParameterMethod(MatchInfo matchInfo) {
        ...
        return TMS_ADD_PARAMETER + "(name=" + nameMatcher.group(PARAMETER_NAME_PARAMETER_NAME) +
                PARAMETERS_SEPARATOR_OBJECT + "value=" + valueMatcher.group(PARAMETER_VALUE_PARAMETER_NAME) + ")";
    }
}