...
public class PytestOrNoseSnippet {
    ...
    public static String getNewSnippetPytestOrNose(Object userObject) {
        ...
        for (String line : CODE_SNIPPET.lines().toList()) {
            String modifiedLine = line
                .replace("testName", StringUtils.spacesToSnakeCase(testName).toLowerCase())
